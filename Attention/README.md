# Project 11: Masked Language Modeling with Attention

## Description
This project implements an **AI that predicts masked words** in English text using a transformer-based language model.  
We use **BERT** (Bidirectional Encoder Representations from Transformers) to predict masked tokens based on context and generate visualizations of attention patterns.
