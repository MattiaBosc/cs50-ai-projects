...
class MinesweeperAI():
    ...
    def make_safe_move(self):
        ...
        safe_move = random.choice(list(self.safes))               
        while safe_move in self.moves_made:
            safe_move = random.choice(list(self.safes))
    ...
    def make_random_move(self):
        ...
        """
        if len(self.moves_made.union(self.mines)) == self.width * self.height:
            return None
        
        random_move = (round(random.randint(0, 7)), round(random.randint(0, 7)))
